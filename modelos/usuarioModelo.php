...
class usuarioModelo {
    ...
    public function salvar($usuarioModelo) { //Função de interação com /controlles/produtoController.php
        global $con;
    ...
    public function excluir($id) {
        ...
        if ($con->query($sql) === TRUE) {
            echo "<br>Usuário delete com sucesso!";
        } else {
    ...
    public function listar() {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($obj = $result->fetch_object("usuarioModelo")) {
    ...
    public function editar($usuarioModelo) {
        global $con;

        $sql = "UPDATE usuario SET  nome =  '{$usuarioModelo->getnome()}' ,"
                . "rg =  '{$usuarioModelo->getrg()}' , "
                . "cpf =  '{$usuarioModelo->getcpf()}' , "
                . "datadeNascimento =  '{$usuarioModelo->getdatadeNascimento()}' , "
                . "sexo =  '{$usuarioModelo->getsexo()}' , "
                . "estadoCivil =  '{$usuarioModelo->getestadoCivil()}' , "
                . "logradouro = '{$usuarioModelo->getlogradouro()}', "
                . "numero = '{$usuarioModelo->getnumero()}', "
                . "bairro = '{$usuarioModelo->getbairro()}', "
                . "cidade = '{$usuarioModelo->getcidade()}', "
                . "estado = '{$usuarioModelo->getestado()}', "
                . "turno = '{$usuarioModelo->getturno()}', "
                . "horarioEntrada = '{$usuarioModelo->gethorarioEntrada()}',"
                . "horarioSaida = '{$usuarioModelo->gethorarioSaida()}' WHERE id = '{$usuarioModelo->getId()}'; ";
